...
public class Xpath_Locators {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        boolean check1 = driver.findElement(By.xpath("//input[@id='input-firstname']")).isDisplayed();
        ...
        boolean check4 = driver.findElement(By.xpath("//input[@type='t' pr @name='telephone']")).isDisplayed();
